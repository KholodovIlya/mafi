...
  move(x, y) {
    this.transform.position.x = (x - layers[0].canvas.offsetLeft) / (layers[0].canvas.offsetWidth / layers[0].canvas.width);
    this.transform.position.y = (y - layers[0].canvas.offsetTop) / (layers[0].canvas.offsetHeight / layers[0].canvas.height);
  }
